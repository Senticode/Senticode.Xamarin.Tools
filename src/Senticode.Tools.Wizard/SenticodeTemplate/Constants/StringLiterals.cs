namespace SenticodeTemplate.Constants
{
    internal static partial class StringLiterals
    {
        ...
        public static readonly string ViewModels = nameof(ViewModels);
        public static readonly string Menu = nameof(Menu);
        public static readonly string Views = nameof(Views);
        public static readonly string Services = nameof(Services);
        public static readonly string Controllers = nameof(Controllers);
        public static readonly string Initializer = nameof(Initializer);
        ...
        public const string PropertyGroupTag = "</PropertyGroup>";
